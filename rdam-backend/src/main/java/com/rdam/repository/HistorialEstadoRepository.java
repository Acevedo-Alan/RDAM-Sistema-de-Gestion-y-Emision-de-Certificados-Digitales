...
public interface HistorialEstadoRepository extends JpaRepository<HistorialEstado, Integer> {
    ...
    List<HistorialEstado> findBySolicitud_Circunscripcion_IdOrderByCreatedAtDesc(Integer circunscripcionId);

    List<HistorialEstado> findAllByOrderByCreatedAtDesc();
}
