...
public class EmailService {
    ...
    public void enviarOtp(String destinatario, String codigo) {
        try {
            ...
            helper.setSubject("RDAM \u2014 C\u00f3digo de verificaci\u00f3n");
                                    ...
                                    <tr>
                                        <td style="background-color:#1a3a5c;padding:24px 32px;">
                                            <h2 style="margin:0;color:#ffffff;font-size:20px;font-weight:600;">
                                                RDAM &mdash; Verificaci&oacute;n de Acceso
                                            </h2>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="padding:32px;">
                                            <p style="margin:0 0 16px;color:#333333;font-size:15px;line-height:1.6;">
                                                Has solicitado iniciar sesi&oacute;n en el
                                            ...
                                            <p style="margin:0 0 24px;color:#333333;font-size:15px;line-height:1.6;">
                                                Este c&oacute;digo expirar&aacute; en <strong>5 minutos</strong>.
                                            </p>
                                    ...
                                    <tr>
                                        <td style="padding:16px 32px 24px;border-top:1px solid #eeeeee;">
                                            <p style="margin:0;color:#999999;font-size:12px;line-height:1.5;
                                                      text-align:center;">
                                                Si no solicitaste este c&oacute;digo, puedes ignorar este correo.
                                            </p>
                                        </td>
                                    </tr>
